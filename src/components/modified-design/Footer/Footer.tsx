...
const Footer: React.FC<FooterProps> = ({ darkMode }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const feedbackData = {
            userId: 'sampleUserId', // Replace with actual user ID if available
    ...
    return (
        <footer className={`${bgClass} py-12 px-6`}>
            <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
                <div className="p-8 space-y-6 text-center">
                    <h2 className={`text-3xl font-extrabold ${textClass}`}>Your Feedback Matters</h2>
