...
const ChaptersChart = ({ data, darkMode }: any) => {
    ...
    return (
        <div className={`p-8 rounded-lg shadow-md ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'}`}>
